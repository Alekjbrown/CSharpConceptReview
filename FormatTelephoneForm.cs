...
{
    public partial class FormatTelephoneForm : Form
    {
        public FormatTelephoneForm()
        {
            InitializeComponent();
        }

        //The IsValidNumber method accepts a string and returns true
        ...
        //The TelephoneFormat method accepts a string argument by reference
